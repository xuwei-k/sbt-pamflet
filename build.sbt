...
lazy val pamfletVersion = "0.7.0-SNAPSHOT"
lazy val pamflet = "net.databinder" %% "pamflet-library" % pamfletVersion
lazy val pamfletKnockoff = "net.databinder" %% "pamflet-knockoff" % pamfletVersion
